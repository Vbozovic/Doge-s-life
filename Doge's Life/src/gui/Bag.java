...
public class Bag {
	...
	public Bag(){
		BufferedImage temp = Util.loadImage("slike/elven bag.png");
	...
	public void render(Graphics2D g){
		...
		dy1 = 15;
		dx2 = dx1+slika.getWidth(null);
		dy2 = slika.getHeight(null);
		
		sx1=0;
		sy1=0;
		sx2=slika.getWidth(null);
		sy2=slika.getHeight(null);
